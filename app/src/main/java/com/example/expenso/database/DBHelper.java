...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS Users (user_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, pin_hash TEXT, age INTEGER, profession TEXT, phone TEXT)");
        ...
        if (oldVersion < 3) {
            ...
            onCreate(db);
             ...
             try {
                 ...
                 // Columns or table might already exist
             }
        }
        if (oldVersion < 5) {
             try {
